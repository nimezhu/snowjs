...
var snow=snow||{};(function(S,d3){S.config=function(){var data;var typeMap={"i":"number","a":"text","s":"text","f":"text","0-index":"text","color":"color","bool":"checkbox"}
...
JSON.parse("["+s.value+"]")},"0-index":function(s){var k=s.value.split(",")
...
return a},"color":function(s){return s.value},"bool":function(d){return d.checked}}
...
var snow=snow||{};(function(S,d3){S.panel=S.panel||{};S.panel.general=function(cb){var ViewPane,CfgPane;var Content;var NavTabs;var NavView,NavCfg;var Div;var Uid
...
var dims;var chart=function(selection){var row=selection;row.selectAll("*").remove();var self=row.selectAll(".box").data([id])
...
header.enter().append("div").attr("class","box-header with-boarder")
header.exit().remove()
header.append("h3").attr("class","box-title").html("<i class='fa fa-file'></i>  "+id);var simple_render=function(){var wait=self.selectAll(".overlay").data([0])
wait.enter().append("div")
wait.attr("class","overlay").append("i").attr("class","fa fa-refresh fa-spin")
wait.exit().remove();var cb=function(){wait.remove();}
self.selectAll(".box-body").remove();var c=self.append("div").attr("class","box-body")
...
if(d.class){d.class.forEach(function(d){b.classed(d,true)})}
var header=b.append("div").classed("box-header",true).classed("with-border",true)
if(d.title){var title=header.append("h3").classed("box-title",true).text(d.title)}
var body=b.append("div").classed("box-body",true)
if(d.panel){if(d.data){if(typeof d.data===typeof[1,2,3]){var divs=body.selectAll("div").data(d.data);divs.exit().remove()
divs.enter().append("div");divs.call(d.panel)}else{body.call(d.panel)}}else{body.call(d.panel)}}})}
