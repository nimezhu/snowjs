...
var snow=snow||{};(function(S,d3){S.panel=S.panel||{};S.panel.general=function(cb){var ViewPane,CfgPane;var Content;var NavTabs;var NavView,NavCfg;var Div;var Uid;var Title=""
...
if(d.title){d.panel.Title(d.title)}
if(d.panel){if(d.data){if(typeof d.data===typeof[1,2,3]){var divs=body.selectAll("div").data(d.data);divs.exit().remove()
divs.enter().append("div");divs.classed("tab-nav-custom",true).call(d.panel)}else{body.call(d.panel)}}else{body.call(d.panel)}}})}
