...
keys.forEach(function(d){if(config[d].v!=undefined){if(config[d].t=="0-index"){chart[d](S.tools.ParseIndexes(config[d].v))}
else{chart[d](config[d].v)}}else{if(config[d].t=="0-index"){chart[d](S.tools.ParseIndexes(config[d].d))}
