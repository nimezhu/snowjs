    ...
    var chart = function(selection) {
      ...
      var brush = d3.brush()
          ...
          if  (overlap([x,x1],[y,y1])) {
              ...
              //if (x!=region.x && y!=region.y && x1!=region.x+region.width && y1!=region.y+region.width) {
              /*
              d3.select(this).transition()
              .call(d3.event.target.move,
                [[region.x,region.x],[region.x+region.width,region.x+region.width]]
              )
              */

              //}
              //brush.extent([[region.x,region.x+region.width],[region.x,region.x+region.width]])
