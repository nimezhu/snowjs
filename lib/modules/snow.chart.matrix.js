...
(function(d3, S) {
  ...
  S.chart.matrix = function() {
    ...
    var chart = function(selection) {
      ...
      var self = row.selectAll(".box").data([id])
      self.enter().append("div")
      self.attr("class", "box box-info").style("height", height+"px").style("width",width+"px").style("overflow", "scroll")
      self.exit().remove()
      ...
      var simple_render = function() {
        ...
        self.selectAll(".box-body").remove();
        var c = self.append("div").attr("class", "box-body")
